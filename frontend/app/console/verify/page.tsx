...
const Console = () => {
    ...
    const cardsContent = [
        {
            title: "URL Analysis",
            content: "Paste any article URL for instant verification"
        },
        {
             title: "Claim Checker",
            content: "Enter specific claims to fact-check"
        },
        {
            title: "Batch Processing",
           content: "Analyze multiple sources at once"
       },
  ...
  return (
    <main>
        ...
        <div className='max-w-4xl mx-auto flex flex-col justify-center min-h-screen'>
            ...
            <Card className='w-full pt-0 mb-10'>
