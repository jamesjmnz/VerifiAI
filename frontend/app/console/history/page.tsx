                ...
                <Table>
                  ...
                  <TableBody>
                    {Array.from({ length: 5 }).map((_, i) => (
                      <TableRow key={i}>
                        <TableCell className="py-5"><Skeleton className="h-4 w-full max-w-[280px] mx-auto" /></TableCell>
                        <TableCell className="py-5"><Skeleton className="h-4 w-24 mx-auto" /></TableCell>
                        <TableCell className="py-5"><Skeleton className="h-6 w-20 mx-auto rounded-lg" /></TableCell>
                        <TableCell className="py-5"><Skeleton className="h-4 w-20 mx-auto" /></TableCell>
                        <TableCell className="py-5"><Skeleton className="h-8 w-14 mx-auto rounded-md" /></TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
                </Table>
